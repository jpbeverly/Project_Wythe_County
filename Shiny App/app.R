...
sidebar <- dashboardSidebar(
  selectInput("selected", "Select industry:",
              choices = c("Finance and Insurance","Educational Services","Retail Trade","Administrative and Support and Waste Management and ReMediaion Services","Construction"   ),
              selected = "Iowa",
              selectize=TRUE),
  sidebarMenu(id="menu",
              menuItem("industry_fish", tabName = "map", icon = icon("draw-polygon")),
